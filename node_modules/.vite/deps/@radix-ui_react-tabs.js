...
import { t as createContextScope } from "./dist-C6K_FUFO.js";
import { a as useComposedRefs, r as createSlot } from "./dist-BHntBQhn.js";
import { i as composeEventHandlers, n as useControllableState, r as useLayoutEffect2, t as Presence } from "./dist-DhKFdyC9.js";
import { n as useId, t as useCallbackRef } from "./dist-CUDHPS78.js";
import { t as Primitive } from "./dist-CC2Istun.js";
...
function createCollection(name) {
	...
	const CollectionProvider = /* @__PURE__ */ __name$4((props) => {
	...
	__name$4(useCollection, "useCollection");
	return [
		{
...
__name$4(createCollection, "createCollection");
var __instanciated = /* @__PURE__ */ new WeakMap();
var OrderedDict = class _OrderedDict extends Map {
	static {
		__name$4(this, "OrderedDict");
	}
	#keys;
	constructor(entries) {
		super(entries);
...
__name$4(toSafeIndex, "toSafeIndex");
function toSafeInteger(number) {
	return number !== number || number === 0 ? 0 : Math.trunc(number);
}
__name$4(toSafeInteger, "toSafeInteger");
// @__NO_SIDE_EFFECTS__
function createCollection2(name) {
	...
	const [CollectionContextProvider, useCollectionContext] = createCollectionContext(PROVIDER_NAME, {
		...
		setItemMap: /* @__PURE__ */ __name$4(() => void 0, "setItemMap")
	});
	const CollectionProvider = /* @__PURE__ */ __name$4(({ state, ...props }) => {
	...
	CollectionProvider.displayName = PROVIDER_NAME;
	const CollectionInit = /* @__PURE__ */ __name$4((props) => {
	...
	const CollectionProviderImpl = /* @__PURE__ */ __name$4((props) => {
	...
	__name$4(useInitCollection, "useInitCollection");
	function useCollection(scope) {
...
__name$4(createCollection2, "createCollection");
...
__name$4(shallowEqual, "shallowEqual");
function isElementPreceding(a, b) {
	return !!(b.compareDocumentPosition(a) & Node.DOCUMENT_POSITION_PRECEDING);
}
__name$4(isElementPreceding, "isElementPreceding");
function sortByDocumentPosition(a, b) {
	return !a[1].element || !b[1].element ? 0 : isElementPreceding(a[1].element, b[1].element) ? -1 : 1;
}
__name$4(sortByDocumentPosition, "sortByDocumentPosition");
...
__name$4(getChildListObserver, "getChildListObserver");
//#endregion
